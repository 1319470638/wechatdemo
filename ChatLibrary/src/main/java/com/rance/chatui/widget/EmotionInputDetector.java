...
public class EmotionInputDetector {
    ...
    private void showEmotionLayout() {
        ...
        if(checkDeviceHasNavigationBar(mActivity)){
            ...
            mEmotionLayout.getLayoutParams().height = softInputHeight+i;
        }else {
    ...
    private int getSupportSoftInputHeight() {
        ...
        if (softInputHeight > 0) {
            ...
            sp.edit().putInt(SHARE_PREFERENCE_TAG, softInputHeight).commit();
        }
        if (softInputHeight < 0) {
        ...
        Log.d(TAG, "getSupportSoftInputHeight: softInputHeight=="+screenHeight);

...
public class PhotoUtils {
    ...
    public static void takePicture(BaseFragment baseFragment, Uri imageUri, int requestCodeCamera) {
        ...
        if (intentCamera.resolveActivity(baseFragment.getActivity().getPackageManager()) != null)
        {
            baseFragment.startActivityForResult(intentCamera, requestCodeCamera);
        }else {
            Toast.makeText(baseFragment.getActivity(),"没有找到应用，请先去下载",Toast.LENGTH_SHORT).show();
        }
    }
